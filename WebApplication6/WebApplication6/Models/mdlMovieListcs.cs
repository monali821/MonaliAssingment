...
namespace WebApplication6.Models
{
    ...
    public class mdlMovieListTrans
    {
        ...
        public DataSet SearchMovieListMovies(String MListID)
        {
            ...
            SqlDataAdapter adp = new SqlDataAdapter();
            cmd.Connection = cn;
            cmd.CommandText = "Select *,rating=(select rating from Movie_Rating where Movie_Rating.Movie_id=MovieInList.MoviceId)  from MovieInList left join Movie on Movie.movie_id=MovieInList.MoviceId Where MovieInList.MoviceListId='" + MListID + "'";
            adp.SelectCommand = cmd;
            adp.Fill(ds);
            return ds;
        }
